...
- Location: e2e\onboarding.spec.ts:146:3
...
- generic [ref=e9]:
  - generic [ref=e10]:
    - heading "Set monthly budgets" [level=1] [ref=e11]
    - paragraph [ref=e12]: "Optional: set spending limits per category"
  - generic [ref=e13]:
    - button "Skip" [ref=e14] [cursor=pointer]
