...
- Name: budgets.spec.ts >> Budgets >> on-track budget shows On track badge
- Location: e2e\budgets.spec.ts:113:3
...
Locator: getByText('On track').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('On track').first()
