...
- Name: onboarding.spec.ts >> Onboarding >> renders step 1 with default category options
- Location: e2e\onboarding.spec.ts:72:3
...
Locator: getByRole('heading', { name: 'Choose your categories' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Choose your categories' })
